// Para mais icones como estes pode acessar... https://heroicons.com/
...
export const IconeErro = (tamanho = 6 ) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={`h-${tamanho} w-${tamanho}`} stroke="currentColor">
